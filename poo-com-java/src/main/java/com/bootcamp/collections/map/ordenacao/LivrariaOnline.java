package com.bootcamp.collections.map.ordenacao;
...
public class LivrariaOnline {
  ...
  public Map<String, Livro> exibirLivrosOrdenadosPorPreco() {
    List<Map.Entry<String, Livro>> livrosParaOrdenarPrecos = new ArrayList<>(livros.entrySet());

    Collections.sort(livrosParaOrdenarPrecos, new ComparatorPorPreco());

    Map<String, Livro> livrosOrdenadosPorPreco = new LinkedHashMap<>();

    for (Entry<String, Livro> entry : livrosOrdenadosPorPreco.entrySet()) {
